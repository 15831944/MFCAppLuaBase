...
#define tolua_pushcppstring(x,y)                lua_pushlstring(x,y.data(), y.size())//tolua_pushstring(x,y.c_str())
...
TOLUA_API void tolua_function (lua_State* L, const char* name, lua_CFunctionSTD func);
TOLUA_API void tolua_constant (lua_State* L, const char* name, lua_Number value);
TOLUA_API void tolua_variable (lua_State* L, const char* name, lua_CFunctionSTD get, lua_CFunctionSTD set);
